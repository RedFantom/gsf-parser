...
class FileFrame(ttk.Frame):
    """
    Deprecated implementation of FileFrame with support for filtering

    The Modern File Frame does not include filtering support as of yet.
    Therefore, this implementation is provided, available through the
    ["gui"]["fileframe"] setting, for users who still wish to use the
    filtering options.
    """
    ...
    def __init__(self, root_frame, main_window):
        ...
        self.refresh_button = ttk.Button(self, text="Refresh", command=self.update_files)
        self.filters_button = ttk.Button(self, text="Filters", command=Filters)
    ...
    def flip_sorting(self):
        """Flip sorting of files in the Treeview"""
