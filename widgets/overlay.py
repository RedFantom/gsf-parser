...
if sys.platform == "linux":
    ...
    class Overlay(tk.Toplevel):
        ...
        def __init__(self, position, text_variable, wait_time=20, font=("default", 11), master=None,
                     color=(0, 255, 255), opacity=255, auto_init=True, size=(40, 40)):
        ...
        def setup_window(self):
            ...
            self.text_label = ttk.Label(self, textvariable=self._text_variable, font=self._font, background="white",
                                        foreground=FileHandler.color_tuple_to_html(self._color))
            self.wm_attributes("-topmost", True)
            self.wm_attributes("-alpha", self._opacity / 255)
