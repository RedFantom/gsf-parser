...
class ClientConnection(object):
    ...
    def init_conn(self, silent=True):
        ...
        self.address = (variables.settings["sharing"]["server_address"], variables.settings["sharing"]["server_port"])
        self.TIME_OUT = 4
    ...
    def logstr(self, file_name, serv, fact, player_name):
        ...
        if message == -1:
            ...
            self.unexpected()
            return
        with open(variables.settings["parsing"]["path"] + "/" + file_name, "r") as file_obj:
