...
class resources_frame(ttk.Frame):
    def __init__(self, root_frame, main_window):
        ...
        resources_descriptions = {
            "GSF: A starting point":"A guide by comprehensive Pyril with information ranging from the interface to the components and controls. Originally created for Thranta Squadron, but useful for and available to everyone.",
            "Stasiepedia":"A very extensive guide to everything there is in GSF, including advisory builds for every ship. Written in 2014, but still up-to-date due to the lack of updates for GSF. A trusted source of information for many Veteran pilots.",
            "Despon's GSF School":"A YouTube channel with videos about important topics within GSF and a very experienced host. After throwing various types of event to help Rookies learn how to play GSF, he has started this YouTube channel, and with success.",
            "Thranta Squadron Event Calendar":"An interactive calendar containing all events of the GSF community on different servers. This calendar is being kept up-to-date with the GSF forums and it includes times in UTC and server locations.",
        ...
        for resource in resources:
            ...
            resource_description = ttk.Label(self.frame.interior, text = resources_descriptions[resource], justify=tk.LEFT, wraplength = 780)
        ...
        self.explanation_label = ttk.Label(self.frame.interior, text = "In this tab you can find links to all sorts of usefull resources for SWTOR: GSF. Just click the text highlighted in blue to open the resource in your default browser.\n\nIf you have created a resource and would like it to be added to this list, please e-mail RedFantom at redfantom@outlook.com",
