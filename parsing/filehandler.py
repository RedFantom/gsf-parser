...
class FileHandler(object):
    """
    Reads the files generated by ScreenParser for file results, for
    ...
    def get_dictionary_key_secondsless(dictionary, timing):
        ...
        This was mostly required for earlier versions of screen results
    ...
    def get_data_dictionary(name="realtime.db"):
        """Read the real-time results data dictionary from"""
    ...
    def get_features_string(file_name, match_time, spawn_time):
        ...
        """
        # Get the screen results data dictionary
        ...
        if string.endswith(", "):
            ...
            string = "No features enabled for screen results in this match."
        return string
    ...
    def get_power_mgmt_markers(screen_dict, start_time):
        ...
        - Mouse and Keyboard results (keyboard input)
        - Power Management results (screenshots)
        """
    ...
    def get_tracking_markers(screen_dict: dict, ship_stats: ShipStats):
        ...
        if ship_stats is not None and "PrimaryWeapon" in ship_stats:
            ...
            # TODO: Implement (1) key results here and thus support
        ...
        # Loop over screen results cursor position data
